...
- WordPress version
- PHP version
- single-site or multisite context
- expected behaviour
- actual behaviour
- reproduction steps
...
- confirmed plugin defects
- documented behaviour regressions
- installation and upgrade issues

Not supported as free support:

- custom feature implementation
- unrelated third-party plugin conflicts without reproduction
- end-of-life WordPress or PHP versions
